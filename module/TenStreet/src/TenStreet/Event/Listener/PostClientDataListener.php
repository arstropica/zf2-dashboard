 ...
 *        
 */
class PostClientDataListener extends BaseListener implements ListenerAggregateInterface {
	...
	public function attach(EventManagerInterface $events)
	{
		...
		$this->_attachStateful( $sharedManager, 'TenStreet\Service\PostClientDataService', 'PostClientData' );
		...
		try {
			...
			if ($r) {
				...
				if ($entity) {
					...
					foreach ( [ 
							'\Event\Entity\TenStreetApiEvent' => true,
