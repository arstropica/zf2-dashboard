        ...
        if ($this->validateDelete($post)) {
            if (null !== $entity->getAccount()) {
                ...
                try {
                    $em->persist($entity);
                    $em->flush();
                    $this->getServiceEvent()->setMessage("Lead #{$id} was unassigned");
                    $this->logEvent("EditAction.post");
                } catch (\Exception $e) {
                    $this->logError($e);
                    $this->flashMessenger()->addErrorMessage($this->getServiceLocator()
            ...
            foreach ($actions as $action) {
                ...
                switch ($action) {
                    ...
                    case 'assign':
                        ...
                        if ($lead instanceof Lead && $account instanceof Account) {
                            ...
                            try {
                                ...
                                $this->getServiceEvent()->setMessage("Lead #{$lead_id} was assigned to " . $account->getName());
                                $shouldLog = true;
                            } catch (\Exception $e) {
                                $this->logError($e);
                                return false;
                    ...
                    case 'unassign':
                        ...
                        if (($lead instanceof Lead) && (null !== $lead->getAccount())) {
                            ...
                            try {
                                ...
                                $this->getServiceEvent()->setMessage("Lead #{$lead_id} was unassigned");
                                $shouldLog = true;
                            } catch (\Exception $e) {
                                $this->logError($e);
                                return false;
                    ...
                    case 'submit':
                        ...
                        try {
                            $response = $this->forward()->dispatch('Lead\Controller\Services', array(
                                'action' => 'process',
                                'id' => $lead_id
                            ));
                    ...
                    case 'delete':
                        $this->getServiceEvent()->setMessage("Lead #{$lead_id} was deleted.");
