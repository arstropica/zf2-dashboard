...
class Lead
{
    ...
    {
        return $this->getAttributes(true)->filter(function ($leadAttribute) use($attributeName) {
    ...
    {
        return $this->getEvents(true)->filter(function (\Event\Entity\LeadEvent $event) use($eventName) {
