...
class ImportForm extends Form implements InputFilterAwareInterface, 
		ObjectManagerAwareInterface
{
	...
	public function init ()
	{
		...
		$objectManager = $this->serviceLocator->get(
		...
		if ($leadData) {
			foreach ($leadData as $i => $lead) {
				foreach ($lead as $field => $value) {
					$leadAttributeValuesFieldset->add(
							array(
									'name' => "{$i}[{$field}]",
									'attributes' => array(
											'value' => $value,
	...
	public function getAttributeFields ()
	{
		...
		$attributes = $attributeRepository->getUniqueArray(true);
